...
{
	public enum GuiType {HEADER, TEXTVIEW, SWITCH, TEXTVIEW_SUMMARY, HEADER_SUMMARY, CHECKBOX};
	 ...
	 */
	public NavigationMenuItem(String menuName, String tag, GuiType guiType, OnClickListener onClickListener)
	{
	 ...
	 */
	public NavigationMenuItem(String menuName, String tag, GuiType guiType, String summary, OnClickListener onClickListener)
	{
		this.menuName = menuName;
		this.tag = tag;
		this.guiType = guiType;
	 ...
	 */
	public NavigationMenuItem(String menuName, String tag, GuiType guiType, String summary, int iconRes, OnClickListener onClickListener)
	{
		this.menuName = menuName;
		this.tag = tag;
		this.guiType = guiType;
